...
const DATA = [
    ...
    {
        "DasboardName": "New Dashboard",
        "DashboardId": "114",
        "isActive": "N"
    },
    {
        "DasboardName": "New Dashboard for Demo",
        "DashboardId": "112",
        "isActive": "N"
    }
]
    ...
    if (staticData.length != 0) {
        staticData.forEach((item, index) => {
            ...
            if(tableType == "DASHBOARD_LIST"){
                ...
                //radio.value = item.DasboardName;
                const td1 = document.createElement('td');
                td1.appendChild(radio);
                tr.appendChild(td1);

                // var label = document.createElement("label");
                // label.innerHTML = item.DasboardName;
                // const td2 = document.createElement('td');
                ...
                const dashboard = document.querySelector('#ManageDashboard');
                console.log("dashboard ::: "+dashboard);

                dashboard.addEventListener('change', function(){
                    let selectedValue;
                    for (const radioButton of radioButtons) {
                        console.log("radioButton.checked : "+radioButton.checked);
