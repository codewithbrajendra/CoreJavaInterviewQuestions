...
public class PredicateEmployeeExample {
    ...
    public static void main(String[] args) {
       ...
       // System.out.println("Filtered young employees ::: "+youngEmployees);
        ...
        for(EmployeePredicate employeePredicate : employees) {
            /*if(youngEmp.test(employeePredicate)) {
                System.out.println("Young employees ::: "+employeePredicate);
            }*/

            /*if(femaleEmp.test(employeePredicate)) {
                System.out.println("Female employees ::: "+employeePredicate);
            }*/
